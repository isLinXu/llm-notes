...
![image-0](https://github.com/isLinXu/llm-notes/assets/59380685/063de5ab-dd03-4028-89fa-ecefa4423b0b)
...
![image](https://github.com/isLinXu/llm-notes/assets/59380685/68577acd-bc82-4265-ae43-c1ddbaeec921)


接下来打开刚刚租用服务器的 `进入开发机`，并且打开其中的终端开始环境配置、模型下载和运行 `demo`。

![image-1](https://github.com/isLinXu/llm-notes/assets/59380685/cec11803-3108-4681-b822-d99aa937bcf9)


进入开发机后，在页面的左上角可以切换 `JupyterLab`、`终端` 和  `VScode`，并在终端输入 `bash` 命令，进入 `conda` 环境。如下图所示：

![image-11](https://github.com/isLinXu/llm-notes/assets/59380685/dcd866d7-4959-4a8c-ad1a-8527d885da5d)
...
![image-2](https://github.com/isLinXu/llm-notes/assets/59380685/4d1e3687-4e98-4f48-b375-6ba7e675dcc7)
...
![image-5](https://github.com/isLinXu/llm-notes/assets/59380685/cd198817-8fff-4403-9ee9-c5be3a800b21)
...
![image-5](https://github.com/isLinXu/llm-notes/assets/59380685/951f0ee5-972d-4650-a175-7c32481c9146)
...
cat ~\.ssh\id_rsa.pub
```
![image-52](https://github.com/isLinXu/llm-notes/assets/59380685/5d8e5f10-98ce-4986-88be-3ebb6e33b827)

4. 将公钥复制到剪贴板中，然后回到 `InternStudio` 控制台，点击配置SSH Key。如下图所示：

![image-53](https://github.com/isLinXu/llm-notes/assets/59380685/4f47aa78-32a8-4cea-87e7-44281ffad310)

5. 将刚刚复制的公钥添加进入即可。

![image-54](https://github.com/isLinXu/llm-notes/assets/59380685/188089bd-2d12-46dc-adf0-0c6193d109cf)
...
![image-55](https://github.com/isLinXu/llm-notes/assets/59380685/8b73b2f9-ea38-462d-a9a4-d1b92d436d9d)
