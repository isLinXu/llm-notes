...
![head](https://github.com/isLinXu/llm-notes/assets/59380685/8e2ad263-ed2f-4733-a9bc-88bd39476e89)
...
![Lagent](https://github.com/isLinXu/llm-notes/assets/59380685/c770c295-02a2-4631-9364-c6b112133c3d)
...
![image](https://github.com/isLinXu/llm-notes/assets/59380685/66db4166-c2b4-4788-9436-2a5760e9c7c4)

接下来打开刚刚租用服务器的`进入开发机`，并且打开其中的终端开始环境配置、模型下载和运行 `demo`。

![image-1](https://github.com/isLinXu/llm-notes/assets/59380685/4ae11caf-c447-490b-83dc-a28ca8b45aaf)

进入开发机后，在页面的左上角可以切换 `JupyterLab`、`终端`和 `VScode`，并在终端输入 `bash` 命令，进入 `conda` 环境。如下图所示：

![image-11](https://github.com/isLinXu/llm-notes/assets/59380685/c3fc9a44-a0ab-48c8-a1d4-e3e35f226ac6)
...
![image-2](https://github.com/isLinXu/llm-notes/assets/59380685/fffe4bb1-bab4-493b-a0c0-2dcf44b67811)
...
![image-3](https://github.com/isLinXu/llm-notes/assets/59380685/2c1b4358-ef5e-4e71-906c-1f6b45717c0a)
...
```
![image-18](https://github.com/isLinXu/llm-notes/assets/59380685/3902b57d-bd32-4c04-9afb-38be68614e30)
...
![image-12](https://github.com/isLinXu/llm-notes/assets/59380685/2e49a4c3-921e-4509-a7a2-a618366f1364)

注意：要在浏览器打开 `http://127.0.0.1:6006` 页面后，模型才会加载，如下图所示：

![image-5](https://github.com/isLinXu/llm-notes/assets/59380685/fbd075d8-7dc0-4c3d-98a7-d2560bba489b)


在加载完模型之后，就可以与 InternLM-Chat-7B 进行对话了，如下图所示：

![image-6](https://github.com/isLinXu/llm-notes/assets/59380685/fa295ff0-1a4a-4d9a-9aab-86dfe8911b59)
...
![image-7](https://github.com/isLinXu/llm-notes/assets/59380685/2b45a9b9-9aa8-4f3a-a75e-4ab3a81cfe71)
...
![image-8](https://github.com/isLinXu/llm-notes/assets/59380685/c8366546-29c9-4efd-81b1-56a02b82dcda)
...
![image-9](https://github.com/isLinXu/llm-notes/assets/59380685/df4295c2-ccfe-4a3f-83c5-c8667b03b68d)

接下来，我们可以体验一下图片理解的能力，如下所示~

![image-10](https://github.com/isLinXu/llm-notes/assets/59380685/63466f75-f4ad-44df-b902-9f62260f0ae1)
...
ssh-keygen -t rsa
```
![image-13](https://github.com/isLinXu/llm-notes/assets/59380685/9f31c6ca-0586-49dc-aee2-9139cd60b190)
...
![image-14](https://github.com/isLinXu/llm-notes/assets/59380685/1c2319c5-6600-4503-80bb-159aa901ef78)

步骤④：将公钥复制到剪贴板中，然后回到 `InternStudio` 控制台，点击配置 SSH Key。如下图所示：

![image-14](https://github.com/isLinXu/llm-notes/assets/59380685/ba876941-9e69-46f3-a8c2-9d265664c3c7)

步骤⑤：将刚刚复制的公钥添加进入即可。

![image-16](https://github.com/isLinXu/llm-notes/assets/59380685/6d9f9778-39ed-47b6-959b-7ec694b0e488)
...
![image-17](https://github.com/isLinXu/llm-notes/assets/59380685/88ff3f7a-845d-434b-9224-23544f17e698)
